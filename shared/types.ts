...
export const SHOP_CATALOG: ShopItem[] = [
  ...
  // --- Social Benefits ---
  { id: 'social_andorra', name: 'Mudanza a Andorra', price: 500_000_000_000, type: 'social', description: 'Otorga una exención fiscal que anula completamente la posibilidad de que Hacienda te incaute dinero. Además, añade el sello de Andorra a tu nombre de forma permanente.' },
];
